...
def main():
    ...
    solver_params = Solver_parameters(solver_type='QA', maxiter=10, maxiter_gamma=10, annealingtime=100, N_iter_per_reads=None, numreads=1000, alpha=np.sqrt(2)/2, linesearch_method='bisection', perturbation=0) # Solver parameters
...
if __name__ == '__main__':
    print('Solves the 1D Helmholtz problem at coarse precision (10 box-algorithm iterations)')
    main()
